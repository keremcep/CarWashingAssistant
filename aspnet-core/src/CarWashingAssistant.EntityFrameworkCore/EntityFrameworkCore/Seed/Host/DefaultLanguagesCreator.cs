...
namespace CarWashingAssistant.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CarWashingAssistantConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(CarWashingAssistantDbContext context)
        {
            _context = context;
        }
