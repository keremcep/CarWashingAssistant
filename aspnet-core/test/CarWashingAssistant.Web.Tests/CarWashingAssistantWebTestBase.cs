...
{
    public abstract class CarWashingAssistantWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CarWashingAssistantWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CarWashingAssistantWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CarWashingAssistantDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CarWashingAssistantDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CarWashingAssistantDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CarWashingAssistantDbContext, Task<T>> func)
        {
            T result;
